...
public class CleanMachineContainer extends BuildCraftContainer {
    ...
    public CleanMachineContainer(InventoryPlayer player, CleanMachineTile tile){
        ...
        this.addSlotToContainer(new MachineSlot(tile,0,79,8,new ItemStack[]{new ItemStack(ItemLoader.filter),new ItemStack(ItemLoader.charcoalFilter)},1));

        this.addSlotToContainer(new MachineSlot(tile,1,79,49,null,64));
